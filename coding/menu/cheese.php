...
if (isset($_POST['add'])){
    if(isset($_SESSION['cart'])){
        ...
        if(in_array($_POST['product_id'], $item_array_id)){
            ...
            echo "<script>window.location = 'cheese.php'</script>";
        }else{
...
<div class="container">
        <div class="row text-center py-5">
            <?php
                ...
                $sql = "SELECT * from menu where Categories ='cheese'";
                ...
                while ($row = mysqli_fetch_assoc($result)){
                    ...
                    <div class='col-md-3 col-sm-6 my-3 my-md-3'>
                        <form action='cheese.php' method='post'>
                            <div class='card shadow'>
                                <div>
                                    <img src='cheese\\$row[Icon]' alt='Image1' name='icon' class='card-img-top img'>
